		...
		<div class="row">
			<div class="col-xl-3 col-md-4">
				...
				<div class="widget settings-menu">
					<ul>
						<li class="nav-item">
							<a href="index.php?option=com_users&task=edit&id=<?= $user->getId(); ?>" class="nav-link ">
								<i class="far fa-user"></i> <span>Profile Settings</span>
							</a>
						</li>
						<li class="nav-item">
							<a href="index.php?option=com_users&task=editPass&id=<?= $user->getId(); ?>" class="nav-link active">
