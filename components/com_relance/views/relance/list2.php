	...
	<div class="content container-fluid">
		...
		<div class="page-header">
			<div class="row align-items-center">
				<div class="col">
					<h3 class="page-title">Relances non traitées</h3>
					<ul class="breadcrumb">
						<li class="breadcrumb-item"><a href="index.php">Tableau de bord</a></li>
						<li class="breadcrumb-item"><a href="index.php?option=com_relance">Relances</a></li>
						<li class="breadcrumb-item active">Relances non traitées</li>
					</ul>
				</div>
				<div class="col-auto">
			...
			<div class="col-sm-12">
				...
				<div class="card card-table">
					<div class="card-header">
						<h4 class="card-title">Liste des relances non traitées</h4>
					</div>
					<div class="card-body">
