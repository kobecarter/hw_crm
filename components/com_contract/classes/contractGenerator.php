...
class contractGenerator
{
    ...
    public static function genererCorpsContrat(contract $contract)
    {
        ...
        if ($flagDev && $flagSeo && $flagSocial) {
            return self::templateDevSeoSocial($contract, $agence, $client, $parCategorie);
        } elseif ($flagSeo && $flagDev) {
            return self::templateDevSeo($contract, $agence, $client, $parCategorie);
        } elseif ($flagSocial && $flagDev) {
            return self::templateDevSocial($contract, $agence, $client, $parCategorie);
        } elseif ($flagSeo) {
            return self::templateSeoSeul($contract, $agence, $client, $parCategorie);
        } elseif ($flagSocial) {
            return self::templateSocialSeul($contract, $agence, $client, $parCategorie);
        } elseif ($flagDev) {
            return self::templateDevSeul($contract, $agence, $client, $parCategorie);
        }
        return self::templateGenerique($contract, $agence, $client, $devis);
    }
