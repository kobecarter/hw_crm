...
// controleur.php). Signature électronique "maison" (nom tapé + case à cocher + horodatage + IP)
// tant que SignWell n'est pas configuré - voir SIGNWELL_API_KEY dans config.secrets.php. Un seul
...
if ($task === 'accepterOffre') {
    ...
    // avoir le même rendu que ce que le candidat a consulté avant d'accepter.
