...
class aiClientSummary
{
    public static function generate($client)
    {
        ...
        $systemPrompt = "Tu es un assistant intégré à un CRM d'agence qui aide à synthétiser l'historique "
            . "d'un client à partir de ses devis, factures et paiements. Réponds en français, en 3 à 6 phrases "
            ...
            . "réponse (pas de titre, pas de formule de politesse).";
