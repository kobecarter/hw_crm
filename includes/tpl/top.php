				...
				<?php if (!$_SESSION['user']->isResourceHumaine()) : ?>
					...
					<li class="nav-item dropdown has-arrow">
						...
						<a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button">
							<img src="../images/langues/<?php echo $currentlang->getFlag(); ?>" alt="" height="20"> <span><?php echo $currentlang->getNom(); ?></span>
						</a>
						<div class="dropdown-menu dropdown-menu-right">
							<?php $langues = langue::findAll(); ?>
							<?php foreach ($langues as $langue): ?>
								<a href="javascript:void(0);" class="dropdown-item switch-lang" data-lang="<?= $langue->getCode() ?>">
									<img src="../images/langues/<?php echo $langue->getFlag(); ?>" alt="" height="16"> <?php echo $langue->getNom(); ?>
								</a>
							<?php endforeach ?>
						</div>
					</li>
